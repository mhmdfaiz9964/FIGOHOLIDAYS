    ...
    <div x-data="offerManager()" class="space-y-10 animate-in fade-in duration-700 pb-20">
        ...
        <div class="flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-slate-400 mt-2 font-semibold">Build a comprehensive travel package with itinerary and
                    media.</p>
            </div>
        </div>
        ...
        <form action="{{ route('offers.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="space-y-2 lg:col-span-2">
                        ...
                        <input type="text" name="title" required
                            ...
                            placeholder="e.g. 7 Days Luxury Escape to Maldives">
                    </div>
                    <div class="space-y-2">
                    ...
                    <div class="space-y-2">
                        ...
                        @error('offer_type_id') <p class="text-rose-500 text-[10px] font-bold mt-1 px-1">{{ $message }}
                        </p> @enderror
                    </div>
                    ...
                    <div class="space-y-2">
                        <label class="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Offer Price ($)
                            <span class="text-slate-300 font-medium">(Optional)</span></label>
                ...
                <div class="space-y-6">
                    <div class="space-y-2">
                        <label class="text-xs font-black text-slate-400 uppercase tracking-widest px-1">More Details /
                            Description</label>
                        <textarea name="more_details" id="more_details" class="ckeditor"></textarea>
                    </div>
                    <div class="space-y-2">
                        <label class="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Cancellation
                            Policy</label>
                        <textarea name="cancellation_policy" id="cancellation_policy" class="ckeditor"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] border border-slate-50 shadow-sm p-10 space-y-10">
                <div class="flex items-center gap-4 border-b border-slate-50 pb-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Images, Gallery, and
                            Videos</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    <div class="space-y-4">
                        <label class="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Main
                            Thumbnail</label>
                        <div
                            class="relative group aspect-video rounded-3xl overflow-hidden bg-slate-50 border-2 border-dashed border-slate-200 hover:border-[#0F4A3B]/20 transition-all">
                            <input type="file" name="thumbnail_image" required @change="previewMedia($event, 'thumb')"
                                class="absolute inset-0 opacity-0 cursor-pointer z-10">
                            <template x-if="previews.thumb">
                                <img :src="previews.thumb" class="w-full h-full object-cover">
                            </template>
                            <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none"
                                x-show="!previews.thumb">
                    ...
                    <div class="space-y-4">
                        <label class="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Promotional
                            Video <span class="text-slate-300 italic">(Optional - 50MB)</span></label>
                        <div
                            class="relative group aspect-video rounded-3xl overflow-hidden bg-slate-50 border-2 border-dashed border-slate-200 hover:border-[#0F4A3B]/20 transition-all">
                            ...
                            <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                ...
                                <p class="text-[10px] font-black text-slate-300 uppercase mt-2"
                                    x-text="previews.video_name || 'Upload Video'"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div
                            ...
                            <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                ...
                                <p class="text-[10px] font-black text-slate-300 uppercase mt-2"
                                    x-text="previews.gallery_count ? previews.gallery_count + ' Images Selected' : 'Upload Gallery'">
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-[2.5rem] border border-slate-50 shadow-sm p-10 space-y-10">
                <div class="flex items-center gap-4 border-b border-slate-50 pb-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">One special banner
                            for this offer's detail page</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-10">
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Banner
                                    Label</label>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="sidebar_banner_description" rows="2"
                                class="w-full px-5 py-3 bg-slate-50 border-transparent rounded-xl font-bold text-sm outline-none"></textarea>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Target
                                    URL</label>
                                <input type="text" name="sidebar_banner_url"
                                    class="w-full px-5 py-3 bg-slate-50 border-transparent rounded-xl font-bold text-sm outline-none"
                                    placeholder="https://...">
                            </div>
                            <div class="space-y-2">
                                <label
                                    class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Background
                                    Image</label>
                    ...
                    <div
                        class="bg-indigo-50/30 rounded-3xl p-6 border border-indigo-100/50 flex items-center justify-center">
                        <p class="text-xs font-bold text-indigo-400 italic">Static preview of sidebar layout will appear
                            on frontend.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center justify-between border-b border-slate-50 pb-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Define day-by-day
                                activities and routes</p>
                        </div>
                    </div>
                    <button type="button" @click="addDay()"
                        class="px-6 py-3 bg-[#0F4A3B] text-white rounded-xl font-black text-xs hover:scale-105 transition-all shadow-lg shadow-[#0F4A3B]/20">
                        + Add Day Plan
                    </button>
                </div>
                    ...
                    <template x-for="(day, index) in itineraries" :key="day.id">
                        <div
                            ...
                            <button type="button" @click="removeDay(index)"
                                class="absolute top-6 right-6 w-10 h-10 bg-white shadow-sm border border-rose-50 rounded-xl flex items-center justify-center text-rose-500 hover:bg-rose-500 hover:text-white transition-all">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                                <div class="lg:col-span-1 space-y-4">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" :name="'itineraries['+index+'][day]'" x-model="day.day_label"
                                            class="w-full px-5 py-3 bg-white border-transparent rounded-xl font-black text-[#0F4A3B] outline-none">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-black text-slate-400 uppercase">Upload Day Images
                                            (Multiple)</label>
                                        <div
                                ...
                                <div class="lg:col-span-3 space-y-6">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" :name="'itineraries['+index+'][title]'"
                                            class="w-full px-5 py-3 bg-white border-transparent rounded-xl font-bold text-slate-900 outline-none"
                                            placeholder="e.g. Arrival in Negombo and Beach Dinner">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-black text-slate-400 uppercase">Description /
                                            Details</label>
                                        <textarea :name="'itineraries['+index+'][description]'" rows="3"
                                            class="w-full px-5 py-3 bg-white border-transparent rounded-xl font-medium text-slate-600 outline-none text-sm ckeditor-it"></textarea>
                                    </div>
                                            ...
                                            <template x-for="(act, actIndex) in day.activities" :key="act.id">
                                                <div
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        placeholder="Activity (e.g. Hiking)">
            ...
            <div class="sticky bottom-10 left-0 right-0 z-50 px-10">
                <div
                    class="bg-white/80 backdrop-blur-xl border border-white p-6 rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6">
                    <div class="flex items-center gap-6">
                        <div class="flex flex-col">
                            <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Global
                                Status</span>
                        ...
                        <div x-show="isUploading" class="flex flex-col">
                            <span class="text-[10px] font-black text-[#0F4A3B] uppercase tracking-widest">Processing
                                Assets...</span>
                            <div class="w-32 bg-slate-100 h-1.5 rounded-full mt-2 overflow-hidden">
                                <div class="bg-[#0F4A3B] h-full animate-[progress_2s_ease-in-out_infinite]"
                                    style="width: 100%"></div>
                            </div>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 w-full md:w-auto">
                        <a href="{{ route('offers.index') }}"
                            class="px-8 py-4 bg-slate-100 text-slate-400 rounded-2xl font-bold hover:bg-slate-200 transition-all text-sm">Draft
                            & Exit</a>
                        <button type="submit"
                            class="flex-1 md:flex-none px-12 py-4 bg-[#0F4A3B] text-white rounded-2xl font-black shadow-xl shadow-[#0F4A3B]/20 hover:scale-105 active:scale-95 transition-all text-sm">
                            Create Master Offer
                        </button>
                    </div>
                </div>
            ...
            <div @click.away="showTypeModal = false"
                ...
                <div class="mt-8 space-y-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" x-model="newTypeName"
