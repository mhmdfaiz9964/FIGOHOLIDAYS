    ...
    <div x-data="{ 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div class="bg-white rounded-[2.5rem] border border-slate-50 shadow-sm p-10">
                <form action="{{ route('offer-categories.store') }}" method="POST" enctype="multipart/form-data"
                    class="space-y-8">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Banner Image
                                (5MB Max)</label>
                    ...
                    <div class="pt-6 border-t border-slate-50">
                        <button type="submit"
                            class="w-full py-5 bg-[#0F4A3B] text-white rounded-2xl font-black text-lg shadow-xl shadow-[#0F4A3B]/20 hover:opacity-95 transition-all">
                            Publish Category
                        </button>
                    </div>
                </form>
                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-50 shadow-sm overflow-hidden group">
                    ...
                    <div class="p-8">
                        <div class="flex items-center justify-between mb-4">
                            <span
                                class="px-3 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-black uppercase tracking-widest rounded-lg border border-emerald-100">Live
                                Status</span>
                            <span class="text-[10px] font-bold text-slate-400 uppercase tracking-tight"
                                x-text="'slug: ' + slug"></span>
                        </div>
                        <p class="text-sm font-bold text-slate-400">This is how the category meta-info will be stored
