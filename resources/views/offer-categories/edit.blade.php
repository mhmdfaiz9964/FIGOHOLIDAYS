    ...
    <div x-data="{ 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div class="bg-white rounded-[2.5rem] border border-slate-50 shadow-sm p-10">
                <form action="{{ route('offer-categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Update Banner (Optional)</label>
                    ...
                    <div class="pt-6 border-t border-slate-50 flex gap-4">
                        <a href="{{ route('offer-categories.index') }}" class="px-8 py-5 bg-slate-50 text-slate-400 rounded-2xl font-bold hover:bg-slate-100 transition-all">Cancel</a>
                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-50 shadow-sm overflow-hidden group">
                    ...
                    <div class="p-8">
                        <div class="flex items-center justify-between mb-4">
                            <span class="px-3 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-black uppercase tracking-widest rounded-lg border border-emerald-100">Visibility: <span x-text="$root.querySelector('select').value"></span></span>
