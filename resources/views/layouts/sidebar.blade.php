...
<!-- 
                ...
                <a href="{{ route('hotel-types.index') }}" class="group flex items-center gap-3 px-4 py-3.5 rounded-2xl transition-all {{ request()->routeIs('hotel-types.*') ? 'bg-[#0F4A3B] text-white shadow-xl shadow-[#0F4A3B]/20' : 'text-slate-500 hover:bg-slate-50 hover:text-[#0F4A3B]' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                    </svg>
                    <span class="font-bold text-sm">Hotel Types</span>
                </a>
                ...
                <a href="{{ route('transportations.index') }}" class="group flex items-center gap-3 px-4 py-3.5 rounded-2xl transition-all {{ request()->routeIs('transportations.index') ? 'bg-[#0F4A3B] text-white shadow-xl shadow-[#0F4A3B]/20' : 'text-slate-500 hover:bg-slate-50 hover:text-[#0F4A3B]' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                    <span class="font-bold text-sm">Transportation List</span>
                </a>

                <a href="{{ route('transportations.page.edit') }}" class="group flex items-center gap-3 px-4 py-3.5 rounded-2xl transition-all {{ request()->routeIs('transportations.page.edit') ? 'bg-[#0F4A3B] text-white shadow-xl shadow-[#0F4A3B]/20' : 'text-slate-500 hover:bg-slate-50 hover:text-[#0F4A3B]' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <span class="font-bold text-sm">Transportation Page</span>
                </a>
            </div>
        </div>
