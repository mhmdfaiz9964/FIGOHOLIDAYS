<x-app-layout>
    <div x-data="{ 
        ...
        <div class="flex items-center gap-6">
            ...
            <div>
                <h1 class="text-4xl font-black text-slate-900 tracking-tight">Add New Partner</h1>
                <p class="text-slate-400 mt-2 font-semibold">Register a new collaboration partner logo.</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div class="bg-white rounded-[2.5rem] border border-slate-50 shadow-sm p-10">
                <form action="{{ route('partners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="space-y-2">
                        <label class="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Logo Upload</label>
                        <div class="relative group">
                            <input type="file" name="image" required @change="handleFile"
                            ...
                            <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none" x-show="!preview">
                                ...
                                <p class="text-sm font-black text-slate-300 mt-2 uppercase tracking-widest">Select Image</p>
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-50 shadow-sm p-12 flex flex-col items-center justify-center min-h-[400px]">
                    <div class="w-full max-w-sm aspect-square bg-slate-50 rounded-[2rem] overflow-hidden flex items-center justify-center border border-dashed border-slate-200 relative">
                        ...
                        <template x-if="!preview">
                            <div class="text-center p-8">
                                <p class="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em]">Logo Preview</p>
                            </div>
                        </template>
                    </div>
                    ...
                    <div class="mt-8 text-center" x-show="name">
                        ...
                        <p class="text-xs font-bold text-emerald-600 mt-1 uppercase tracking-widest italic">New Membership</p>
                    </div>
                </div>
            </div>
        </div>
